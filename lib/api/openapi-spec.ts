...
export function getOpenApiSpec(
  ...
  return {
    ...
    info: {
      ...
      description:
        "API for the Stockly inventory management system. All endpoints require authentication via session cookie.",
      version: "1.0.0",
    },
    servers: [{ url: baseUrl }],
    ...
    components: {
      securitySchemes: {
        sessionCookie: {
          ...
          name: "session_id",
          description:
            "Session cookie set after login. Send credentials: 'include' with same-origin requests.",
        },
      },
    },
    paths: {
      ...
      "/api/health": {
        get: {
          ...
          responses: {
            "200": {
              description: "Database, Redis, ImageKit, Brevo status and uptime",
            },
          },
        },
      },
